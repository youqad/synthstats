...
def trajectories_to_tinker_batch(
    ...
    Returns:
        ...
        - loss_mask: Tensor[B, T] - loss mask (single-turn only, if any trajectory has mask)
    ...
    def train_step(self, batch: dict[str, Any]) -> dict[str, float]:
        ...
        Args:
            batch: Training batch with keys:
                ...
                - loss_mask: [B, T] optional think-block mask (single-turn only)
        ...
        original_mask = batch.get("loss_mask")  # may be None or wrong size
        logZ = self._logZ
